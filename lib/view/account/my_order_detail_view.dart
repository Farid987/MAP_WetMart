...
import 'package:Wet_Mart/common_widget/my_order_row.dart';
import 'package:Wet_Mart/view_model/addres_view_mode.dart';
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      (widget.mObj.address == null ||
                              widget.mObj.city == null ||
                              widget.mObj.state == null ||
                              widget.mObj.postalCode == null)
                          ? ""
                          : "${widget.mObj.address}, ${widget.mObj.city}, ${widget.mObj.state}, ${widget.mObj.postalCode}",
                      style:
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            " \RM${(widget.mObj.totalPrice ?? 0).toStringAsFixed(2)}",
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            "+ \RM${(widget.mObj.deliverPrice ?? 0).toStringAsFixed(2)}",
                            textAlign: TextAlign.right,
                            style: TextStyle(
                                color: TColor.primaryText,
                                fontSize: 18,
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            "- \RM${(widget.mObj.discountPrice ?? 0).toStringAsFixed(2)}",
                            textAlign: TextAlign.right,
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            "\RM${(widget.mObj.userPayPrice ?? 0).toStringAsFixed(2)}",
                            textAlign: TextAlign.right,
                            style: TextStyle(
                                color: TColor.primaryText,
                                fontSize: 22,
