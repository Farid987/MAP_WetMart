...
import 'package:Wet_Mart/common_widget/round_button.dart';
import 'package:Wet_Mart/view/account/address_list_view.dart';
import 'package:Wet_Mart/view/account/payment_method_view.dart';
import 'package:Wet_Mart/view/account/promo_code_view.dart';
import 'package:Wet_Mart/view_model/cart_view_model.dart';
      ...
      child: Obx(
        () => Column(
          ...
          children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            "RM ${cartVM.cartTotalPrice.value}",
                            textAlign: TextAlign.end,
                            style: TextStyle(
                                color: TColor.secondaryText,
                                fontSize: 14,
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            "+ RM ${cartVM.deliverPriceAmount.value}",
                            textAlign: TextAlign.end,
                            style: TextStyle(
                                color: TColor.secondaryText,
                                fontSize: 14,
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            "- RM ${cartVM.discountAmount.value}",
                            textAlign: TextAlign.end,
            ...
            CheckoutRow(
              title: "Final Total",
              value: "RM${cartVM.userPayPrice.value}",
              onPressed: () {
                showDialog(
                    context: context,
                    builder: (context) {
